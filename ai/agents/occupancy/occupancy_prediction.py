...
class OccupancyPredictionEngine:
    ...
    def predict(
        self, state: SharedState, current_occupancy: int, trend: TrendDirection
    ) -> OccupancyPredictionModel:
        """
        ...
        try:
            ...
            return self._fallback_prediction(
                current_occupancy, state.zone.capacity, trend
            )
    ...
    def _fallback_prediction(
        self, current_occupancy: int, capacity: int, trend: TrendDirection
    ) -> OccupancyPredictionModel:
        ...
        return OccupancyPredictionModel(
            min_15=current_occupancy, min_30=current_occupancy, min_60=current_occupancy
        )
