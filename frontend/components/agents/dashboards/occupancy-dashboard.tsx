...
export default function OccupancyDashboard({ runResult }: { runResult: AgentSimulationResponse }) {
  const profile = getAgentProfile("occupancy");
  return (
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="p-5 border rounded-xl bg-white shadow-sm">
          ...
          <div className="h-64 flex items-center justify-center bg-gray-50 mt-4 rounded-lg">
             [Domain Specific Chart for Occupancy]
          </div>
        </div>
        <div className="p-5 border rounded-xl bg-white shadow-sm">
